...
import { Phone, Mail, MessageCircle, Clock, MapPin, CheckCircle } from 'lucide-react'
import Image from 'next/image'

export const metadata: Metadata = {
  title: 'Contact - Get Expert Brazilian Business Consulting Services',
  description: 'Contact our Brazilian business consulting experts for professional guidance on company formation, CNPJ registration, business permits, and legal compliance in Brazil.',
  keywords: 'contact Brazilian business consultant, business formation consultation Brazil, CNPJ registration help, company setup assistance Brazil',
  openGraph: {
    title: 'Contact - Get Expert Brazilian Business Consulting Services',
    description: 'Contact our Brazilian business consulting experts for professional guidance on company formation and legal compliance.',
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-700 max-w-3xl mx-auto">
                Get expert consultation for starting your business in Brazil. Our team of professionals 
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                ...
                <p className="text-gray-700 mb-6">
                  Whether you're looking to register as an MEI, start a small company, or establish 
                  a larger corporation, our experienced team provides personalized guidance tailored 
                  to your specific needs and goals.
                </p>
                <p className="text-gray-700 mb-8">
                  We handle all aspects of business formation in Brazil, from initial consultation 
                  to complete registration and ongoing compliance support.
                </p>
        ...
        <section className="py-16 bg-white">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600">Choose the best way to reach us for your business needs</p>
            </div>
                ...
                <Card className="hover:shadow-lg transition-shadow">
                  <CardContent className="pt-6">
                    <div className="flex items-center mb-4">
                      ...
                      <h3 className="text-xl font-semibold text-gray-900">Service Area</h3>
                    </div>
                ...
                <Card className="bg-blue-50 hover:shadow-lg transition-shadow">
                  <CardContent className="pt-6">
                    <div className="flex items-center mb-4">
                      ...
                      <h3 className="text-xl font-semibold text-gray-900">Quick WhatsApp Contact</h3>
                    </div>
                    <p className="text-gray-700 text-sm mb-4">
                      For immediate assistance, message us on WhatsApp and we'll respond right away.
                    </p>
                    <a 
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 max-w-3xl mx-auto">
                Our comprehensive business formation services cover every aspect of starting 
                and maintaining a business in Brazil.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <p className="text-gray-600 text-sm">Complete business registration and CNPJ acquisition</p>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="text-lg font-semibold text-gray-900 mb-2">Permits & Licenses</h3>
                <p className="text-gray-600 text-sm">All necessary permits and regulatory approvals</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 text-sm">Best tax regime selection and compliance guidance</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 text-sm">Ongoing legal and regulatory compliance support</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 text-sm">Professional bookkeeping and financial management</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 text-sm">Strategic business planning and growth advice</p>
              </div>
            </div>
          </div>
        </section>
