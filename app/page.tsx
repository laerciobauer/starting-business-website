...
export const metadata: Metadata = {
  ...
  description:
    "Expert consulting services to help you start a business in Brazil. Get professional guidance for company formation, CNPJ registration, business permits, and full legal compliance in Brazil.",
  keywords:
    "start business Brazil, company formation Brazil, Brazilian business consulting, CNPJ registration, business permits Brazil, MEI registration Brazil",
  openGraph: {
    title:
