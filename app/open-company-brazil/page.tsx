...
export const metadata: Metadata = {
  ...
  description:
    "Complete guide on how to open a company in Brazil. Expert guidance on business structures, legal requirements, registration procedures, and compliance for starting your Brazilian company.",
  keywords:
    "how to open company Brazil, open business Brazil, start company Brazil, business registration Brazil, company formation Brazil",
  openGraph: {
    title: "How to open a Company in Brazil - Complete Business Opening Guide",
    description:
  ...
  const businessTypes = [
    {
      ...
      description:
        "For individual entrepreneurs with revenue up to R$ 81,000/year",
      features: [
        "Free registration",
        "Simplified taxation",
        "One employee allowed",
        "Monthly tax: R$ 71-76",
      ],
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-xl text-gray-700 mb-8">
                  Comprehensive guidance on opening a company in Brazil,
                  including business structure selection, legal requirements,
                  and complete registration procedures for successful business
                  establishment.
                </p>
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 max-w-3xl mx-auto">
                Select the most appropriate business structure based on your
                business size, revenue projections, number of partners, and
            ...
            <div className="grid lg:grid-cols-2 gap-12">
              <div>
                ...
                <p className="text-gray-700 mb-8">
                  Follow these essential steps to properly open your company in
                  Brazil and ensure full legal compliance from the start.
                </p>
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600">
                Understanding the time and financial investment required
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <Card className="hover:shadow-lg transition-shadow">
                <CardContent className="pt-6">
                  ...
                  <p className="text-gray-600 mb-4">
                    Detailed step-by-step process for complete company
                    formalization.
                  </p>
              ...
              <Card className="hover:shadow-lg transition-shadow">
                <CardContent className="pt-6">
                  ...
                  <p className="text-gray-600 mb-4">
                    Expert assistance with Brazilian tax ID registration
                    process.
                  </p>
        ...
        <section className="py-16 bg-green-600">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl text-green-100 mb-8">
              Our experts will guide you through the entire company opening
              process.
            </p>
            <Link href="/contact">
              <Button
