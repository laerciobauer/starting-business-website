...
export const metadata: Metadata = {
  ...
  description:
    "Detailed cost analysis for starting a business in Brazil. Complete breakdown of registration fees, CNPJ costs, permits, accounting, and ongoing expenses for Brazilian companies.",
  keywords:
    "cost start business Brazil, business formation costs Brazil, CNPJ registration fee, company setup costs Brazil, Brazilian business expenses",
  openGraph: {
    title:
    ...
    setup: [
      {
        ...
        cost: "R$ 50-100",
        description: "Reserve company name at Commercial Registry",
      },
      {
      ...
      {
        item: "Commercial registry filing",
        cost: "R$ 200-500",
        description: "Junta Comercial registration fees",
      },
      {
        item: "CNPJ registration",
        cost: "FREE",
        description: "Federal Revenue Service tax ID registration",
      },
      {
        item: "State registration (ICMS)",
        cost: "R$ 50-200",
        description: "State tax authority registration",
      },
      {
        item: "Municipal registration (ISS)",
        cost: "R$ 50-300",
        description: "Municipal tax and permit registration",
      },
      {
        item: "Basic permits (Alvará)",
        cost: "R$ 200-800",
        description: "Municipal operating permit",
      },
      {
        item: "Professional assistance",
        cost: "R$ 800-3,000",
        description: "Lawyer and accountant fees for setup",
      },
    ],
    ongoing: [
      {
        item: "Monthly accounting",
        cost: "R$ 100-800",
        description: "Professional bookkeeping and tax compliance",
      },
      {
        item: "Federal taxes (varies by regime)",
        cost: "R$ 0-2,000+",
        description: "Income tax, PIS, COFINS, CSLL",
      },
      {
        item: "State taxes (ICMS)",
        cost: "R$ 0-1,000+",
        description: "Goods and services circulation tax",
      },
      {
        item: "Municipal taxes (ISS)",
        cost: "R$ 0-500+",
        description: "Services tax (varies by municipality)",
      },
      {
        item: "Annual declarations",
        cost: "R$ 200-1,000",
        description: "Annual tax and regulatory filings",
      },
      {
        item: "Permit renewals",
        cost: "R$ 100-500",
        description: "Annual permit and license renewals",
      },
      {
        item: "Legal compliance",
        cost: "R$ 200-1,000",
        description: "Ongoing legal and regulatory compliance",
      },
    ],
  };
  ...
  const costFactors = [
    {
      ...
      impact: "High",
      description:
        "MEI has minimal costs, while larger companies require more investment and ongoing expenses.",
    },
    {
      factor: "Industry Sector",
      impact: "Medium",
      description:
        "Healthcare, food, and manufacturing require additional permits and compliance costs.",
    },
    {
      factor: "Location (State/City)",
      impact: "Medium",
      description:
        "Tax rates and permit costs vary significantly between municipalities and states.",
    },
    {
      factor: "Tax Regime Selection",
      impact: "High",
      description:
        "Simples Nacional offers lower rates for eligible businesses compared to other regimes.",
    },
    {
      factor: "Professional Services",
      impact: "Medium",
      description:
        "Lawyer and accountant fees vary by region and complexity of business structure.",
    },
    {
      factor: "Number of Partners",
      impact: "Low",
      description:
        "Multiple partners may increase documentation and legal costs slightly.",
    },
  ];
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-xl text-gray-700 mb-8">
                  Detailed cost analysis and financial planning guide for
                  starting your business in Brazil, including all registration
                  fees, permits, ongoing expenses, and tax obligations.
                </p>
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 max-w-3xl mx-auto">
                Compare setup costs, monthly expenses, and annual investment
                required for different business structures in Brazil.
              </p>
            </div>
                        ...
                        <div>
                          ...
                          <div className="grid grid-cols-2 gap-2 text-sm">
                            <div className="flex justify-between">
                              ...
                              <span className="font-medium">
                                {business.monthly.taxes}
                              </span>
                            </div>
                            <div className="flex justify-between">
                              <span className="text-gray-600">Accounting:</span>
                              <span className="font-medium">
                                {business.monthly.accounting}
                              </span>
                            </div>
                            <div className="flex justify-between border-t pt-1">
                              <span className="font-medium text-gray-900">
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600">
                Understanding all components of business formation and ongoing
                expenses
              </p>
            </div>
        ...
        <section className="py-16 bg-white">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 max-w-3xl mx-auto">
                Various factors influence the total cost of starting and
                maintaining a business in Brazil.
              </p>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12">
              <div>
                ...
                <p className="text-gray-700 mb-8">
                  Smart strategies to minimize your business formation and
                  operational costs while maintaining full legal compliance.
                </p>
        ...
        <section className="py-16 bg-white">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600">
                Explore our business formation services
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <Card className="hover:shadow-lg transition-shadow">
                <CardContent className="pt-6">
                  ...
                  <p className="text-gray-600 mb-4">
                    Complete step-by-step company formation process and
                    requirements.
                  </p>
              ...
              <Card className="hover:shadow-lg transition-shadow">
                <CardContent className="pt-6">
                  ...
                  <p className="text-gray-600 mb-4">
                    FREE CNPJ registration process and tax regime selection
                    guidance.
                  </p>
              ...
              <Card className="hover:shadow-lg transition-shadow">
                <CardContent className="pt-6">
                  ...
                  <p className="text-gray-600 mb-4">
                    Complete guide to all permits and licenses with cost
                    breakdown.
                  </p>
        ...
        <section className="py-16 bg-red-600">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl text-red-100 mb-8">
              Get personalized cost analysis and financial planning for your
