      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-gray-300 mb-6 leading-relaxed">
              ...
              Professional guidance for all aspects of Brazilian business
              formation and legal compliance.
            </p>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <p className="text-gray-300 text-sm">
            © {new Date().getFullYear()} Starting a Business in Brazil. Expert
            business consulting services for Brazilian company formation.
          </p>
        </div>
      </div>
    </footer>
